...
@section('title','Laravel :: Edit Category')
...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Efit Category
                <small>Edit category from here...</small>
            </h1>
                ...
                <form role="form" action="{{ route('admin.category.update',$category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-3">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <img src="{{ Storage::disk('local')->url('category/'.$category->image) }}" style="width: 266px; height: 136px;"/><br/>
                                </div>
